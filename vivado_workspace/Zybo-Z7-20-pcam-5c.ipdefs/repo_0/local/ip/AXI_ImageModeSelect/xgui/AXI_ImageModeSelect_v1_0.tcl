...
proc init_gui { IPINST } {
  ...
  set THRESHOLD [ipgui::add_param $IPINST -name "THRESHOLD" -parent ${Page_0}]
  set_property tooltip {Pixel value at and above which binarized mode outputs white (0xFFFFFF)} ${THRESHOLD}
